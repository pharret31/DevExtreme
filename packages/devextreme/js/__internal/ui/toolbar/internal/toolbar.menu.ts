...
import { DROPDOWN_MENU_LIST_FOCUS_MODE_CLASS } from '@ts/ui/toolbar/constants';
    ...
    this._popup = this._createComponent(this._$popup, Popup, {
      ...
      onInitialized(e) {
        ...
        component.$wrapper()
          ...
          .toggleClass(DROPDOWN_MENU_LIST_FOCUS_MODE_CLASS, !!listFocusStateEnabled);
      },
  ...
  _optionChanged(args: OptionChanged<DropDownMenuProperties>): void {
    ...
    switch (name) {
      ...
      case 'listFocusStateEnabled':
        ...
        this._popup?.$wrapper()?.toggleClass(DROPDOWN_MENU_LIST_FOCUS_MODE_CLASS, !!value);
        break;
      case 'onItemRendered':
